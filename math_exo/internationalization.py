...
inequation_: Mapping[str, str] = get_trans_map(25)
equivalent_equation_: Mapping[str, str] = get_trans_map(26)
equivalent_inequation_: Mapping[str, str] = get_trans_map(27)
filter_by_type_: Mapping[str, str] = get_trans_map(28)
frame_: Mapping[str, str] = get_trans_map(29)
interval_: Mapping[str, str] = get_trans_map(30)
framing_: Mapping[str, str] = get_trans_map(31)
domain_: Mapping[str, str] = get_trans_map(32)
find_poly_: Mapping[str, str] = get_trans_map(33)
data_: Mapping[str, str] = get_trans_map(34)
no_solution_: Mapping[str, str] = get_trans_map(35)
and_: Mapping[str, str] = get_trans_map(36)
or_: Mapping[str, str] = get_trans_map(37)
